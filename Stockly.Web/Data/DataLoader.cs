...
public static class DataLoader
{
    ...
    public static void Load(ApplicationDbContext context)
    {
        if (!context.Products.Any())
        {
            ...
            {
                // VERKTYG & BYGG (Lågt saldo på: Laserpass, Klyvsåg, Betongblandare)
                ...
                new Product { Id = Guid.NewGuid(), Name = "Laserpass Grön Stråle 360", Category = "VERKTYG & BYGG", SKU = "VB-LP-360", Price = 3800m, Quantity = 1, MinStockLevel = 2 },
                ...
                new Product { Id = Guid.NewGuid(), Name = "Klyvsåg Bord 2000W", Category = "VERKTYG & BYGG", SKU = "VB-KY-200", Price = 4900m, Quantity = 0, MinStockLevel = 1 },
                new Product { Id = Guid.NewGuid(), Name = "Betongblandare 120L", Category = "VERKTYG & BYGG", SKU = "VB-BB-120", Price = 3450m, Quantity = 2, MinStockLevel = 2 },
                ...
                // EL OCH INSTALLATION (Lågt saldo på: Jordfelsbrytare, Digital Multimeter)
                ...
                new Product { Id = Guid.NewGuid(), Name = "Jordfelsbrytare 4-pol 25A", Category = "EL OCH INSTALLATION", SKU = "EL-JF-4P", Price = 695m, Quantity = 3, MinStockLevel = 4 },
                ...
                new Product { Id = Guid.NewGuid(), Name = "Digital Multimeter Pro", Category = "EL OCH INSTALLATION", SKU = "EL-DM-PRO", Price = 895m, Quantity = 1, MinStockLevel = 2 },
                ...
                // TRÄDGÅRD OCH MASKINER (Lågt saldo på: Robotgräsklippare, Snöslunga, Jordborr)
                ...
                new Product { Id = Guid.NewGuid(), Name = "Robotgräsklippare 1000m2", Category = "TRÄDGÅRD OCH MASKINER", SKU = "TM-RG-100", Price = 12900m, Quantity = 1, MinStockLevel = 1 },
                ...
                new Product { Id = Guid.NewGuid(), Name = "Snöslunga Tvåstegs Bensin", Category = "TRÄDGÅRD OCH MASKINER", SKU = "TM-SS-BE", Price = 8500m, Quantity = 1, MinStockLevel = 2 },
                ...
                new Product { Id = Guid.NewGuid(), Name = "Jordborr Bensin 52cc", Category = "TRÄDGÅRD OCH MASKINER", SKU = "TM-JB-52", Price = 3100m, Quantity = 0, MinStockLevel = 1 },
                ...
                // FÄRG & MÅLERI (Lågt saldo på: Lasyr, Färgspruta)
                ...
                new Product { Id = Guid.NewGuid(), Name = "Lasyr Utomhus Brun 3L", Category = "FÄRG & MÅLERI", SKU = "FM-LU-B3", Price = 645m, Quantity = 2, MinStockLevel = 5 },
                ...
                new Product { Id = Guid.NewGuid(), Name = "Färgspruta Elektrisk 600W", Category = "FÄRG & MÅLERI", SKU = "FM-FS-600", Price = 1250m, Quantity = 1, MinStockLevel = 2 },
                ...
                // VVS & BADRUM (Lågt saldo på: Varmvattenberedare, Vattenmätarkonsol)
                ...
                new Product { Id = Guid.NewGuid(), Name = "Varmvattenberedare 55L", Category = "VVS & BADRUM", SKU = "VV-VB-55", Price = 4800m, Quantity = 1, MinStockLevel = 1 },
                ...
                new Product { Id = Guid.NewGuid(), Name = "Vattenmätarkonsol G20", Category = "VVS & BADRUM", SKU = "VV-VM-20", Price = 385m, Quantity = 0, MinStockLevel = 2 },
